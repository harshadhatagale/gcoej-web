...
export default function page() {
    return (
        <>
            ...
            <h3 className='text-xl font-bold'>Postgraduate Programmes</h3>
            <div className="w-full overflow-x-scroll">
                <table className='my-3 min-w-full border-collapse border border-gray-300 rounded-lg shadow-lg'>
                    <thead>
                        <tr className='bg-blue-600 text-white'>
                    ...
                    <tbody>
                        <tr class="bg-white hover:bg-blue-50">
                            <td className='border-r border-gray-300 px-6 py-4'>1</td>
                            <td className='border-r border-gray-300 px-6 py-4'>Electronics and Telecommunication Engineering (Digital Systems)</td>
                            <td className='border-r border-gray-300 px-6 py-4'>18</td>
                            <td className='border-r border-gray-300 px-6 py-4'>2010</td>
                        </tr>
                        <tr class="bg-white hover:bg-blue-50">
                            <td className='border-r border-gray-300 px-6 py-4'>1</td>
                            <td className='border-r border-gray-300 px-6 py-4'>
                                Heat Power - Mechanical Engineering</td>
                            <td className='border-r border-gray-300 px-6 py-4'>18</td>
                            <td className='border-r border-gray-300 px-6 py-4'>	2021</td>
                        </tr>
                        <tr class="bg-white hover:bg-blue-50">
                            <td className='border-r border-gray-300 px-6 py-4'>1</td>
                            <td className='border-r border-gray-300 px-6 py-4'>	Electrical Instrumentation and Control Engineering</td>
                            <td className='border-r border-gray-300 px-6 py-4'>18</td>
                            <td className='border-r border-gray-300 px-6 py-4'>	2021</td>
                        </tr>
                    </tbody>
            ...
            <h3 className='text-xl font-bold'>Research Programmes (Ph. D.)</h3>
            <div className="w-full overflow-x-scroll">
                <table className='my-3 min-w-full border-collapse border border-gray-300 rounded-lg shadow-lg'>
                    <thead>
                        <tr className='bg-blue-600 text-white'>
                    ...
                    <tbody>
                        <tr class="bg-white hover:bg-blue-50">
                            <td className='border-r border-gray-300 px-6 py-4'>1</td>
                            <td className='border-r border-gray-300 px-6 py-4'>	Mechanical Engineering</td>
                            <td className='border-r border-gray-300 px-6 py-4'>2018</td>
                        </tr>
                        <tr class="bg-white hover:bg-blue-50">
                            <td className='border-r border-gray-300 px-6 py-4'>1</td>
                            <td className='border-r border-gray-300 px-6 py-4'>Instrumentation Engineering</td>
